...
\author{Scott Viteri\thanks{\texttt{scottviteri@gmail.com}. Analysis pipeline, extracted
datasets, and an interactive version of the main network are at
\url{https://github.com/scottviteri/ept-ai-analysis} and
\url{https://scottviteri.com/ept-ai-analysis/}. Draft prepared with automated analysis
assistance (Claude, Anthropic); all extraction code and every number in this draft is
...
An objection (raised by the first author against an earlier draft of this analysis): the magma
